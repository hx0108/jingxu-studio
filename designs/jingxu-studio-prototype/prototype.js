(() => {
  ...
  function Topbar({ stageLabel, density, setDensity, inspectorOpen, setInspectorOpen, setGuideOpen }) {
    return /* @__PURE__ */ React.createElement("header", { className: "topbar" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "breadcrumbs" }, /* @__PURE__ */ React.createElement("span", null, "创作工作台"), /* @__PURE__ */ React.createElement("i", null), /* @__PURE__ */ React.createElement("strong", null, stageLabel))), /* @__PURE__ */ React.createElement("div", { className: "top-actions" }, /* @__PURE__ */ React.createElement("div", { className: "density-switch", "aria-label": "布局密度" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: density === "compact" ? "active" : "", onClick: () => setDensity("compact") }, "紧凑"), /* @__PURE__ */ React.createElement("button", { type: "button", className: density === "comfortable" ? "active" : "", onClick: () => setDensity("comfortable") }, "舒展")), /* @__PURE__ */ React.createElement("button", { type: "button", className: "secondary small", onClick: () => setGuideOpen(true) }, "原型说明"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "inspector-toggle secondary small", onClick: () => setInspectorOpen(!inspectorOpen) }, "检查器")));
  }
