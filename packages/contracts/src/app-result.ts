...
export const projectErrorCodeSchema = z.enum([
  ...
  'SCRIPT_INPUT_UNSUPPORTED',
  'SCRIPT_INPUT_FILE_CANCELLED',
  'SCRIPT_INPUT_FILE_READ_FAILED',
  'SCRIPT_INPUT_ENCODING_INVALID',
  'SCRIPT_REWRITE_UNAVAILABLE',
  ...
  // V2 视频合成与导出（v2-video-composition-export）。
  'VIDEO_COMPOSITION_NOT_READY',
  'VIDEO_SOURCE_MISSING',
  'VIDEO_SOURCE_STALE',
  'VIDEO_SOURCE_CORRUPTED',
  'VIDEO_TRIM_INVALID',
  'VIDEO_AUDIO_INVALID',
